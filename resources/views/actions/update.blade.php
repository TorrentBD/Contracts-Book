...
@section('title','Updating Information')
            ...
            <form class="form-horizontal" name="contact_form" id="contact_form" enctype="multipart/form-data" method="post" action="{{ url('update',$tasks->id) }}" >
               ...
               <fieldset>
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input type="text" placeholder="Your Name" id="f_name" class="form-control" value=" {{ $tasks->f_name }}" name="f_name"><span id="f_name_err" class="error"></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input type="text"  placeholder="Email ID" id="c_email" class="form-control" value=" {{ $tasks->c_email }}" name="c_email"><span id="email_id_err" class="error"></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input type="text" placeholder="Contact Number" id="cont_1" class="form-control" value=" {{ $tasks->cont_1 }}" name="cont_1"><span id="contact_no1_err" class="error"></span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input type="text"  placeholder="Contact Number" id="cont_2" class="form-control" value=" {{ $tasks->cont_2 }} " name="cont_2"><span id="contact_no2_err" class="error"></span>
                    <span class="help-block">Must be 11 digits .</span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input type="file"  id="pro_pic" class="form-control file" value=" {{ $tasks->pro_pic }} " name="pro_pic"><span id="profile_pic_err" class="error"></span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <input type="text"  placeholder="Your website.." id="website" class="form-control" value=" {{ $tasks->website }} " name="website"><span id="last_name_err" class="error"></span>
                  </div>
                </div>
